...
<div class="content">
    <div class="page-title"> 
        ...
        <a href="{{ route('orders.form') }}" class="new_btn_add_service"><i class="fa fa-plus"></i> Add New Order </a>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="categoriProJobs">
                <ul>
                    <li class="activeCategory">PPMP</li>
                    <li onclick="location.href='{{ route('orders.jobs') }}'">Jobs</li>
                    <li>Projects</li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="orderBox_ng">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h4>PPMP No. {{ $ordr['id'] }}</h4>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="odrInner">
                                                <div class="labelText">PPMP Date</div>
                                                <div class="labelValue">{{ date("d-F, Y", strtotime($ordr['job_date'])) }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="odrInner">
                                                ...
                                                <div class="labelValue">{{ substr($ordr['address'], 0, 30) . '...' }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="odrInner">
                                                <div class="labelText">PPMP Duration</div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            ...
                                            <div class="odrInner">
                                                ...
                                                @if($ordr['status'] == 4 || $ordr['status'] == 5 || $ordr['status'] == 6 || $ordr['status'] == 7 || $ordr['status'] == 8 || $ordr['status'] == 9)
                                                <div class="labelValue">{{ $ordr['group']->leaderMobile }}</div>
                                                @else
                                                <div class="labelValue">Not Assign</div>
                                                @endif
                                            </div>
                                        ...
                                        <div class="col-sm-5">
                                            <div class="odrInner">
                                                <div class="labelText">PPMP Service</div>
                                        ...
                                        <div class="col-sm-3">
                                            <a href="{{ url('admin/orders/viewOrder/'.$ordr['id']) }}" class="orderMoreBtn">more Details <span><i class="fa fa-chevron-right" aria-hidden="true"></i></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            if(json.length>0){
                ...
                $.each(json,function(index, value){
                    ...
                    if(value.group.teamleader_image == null || value.group.teamleader_image == ''){
                        var teamleader_image = '<img src="{{ asset("public/img/defaultIcon.png")}}" class="img-responsive" />';
