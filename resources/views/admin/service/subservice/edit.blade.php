    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-4 ">
                ...
                <form action="{{ url('admin/services/'.$service_id.'/editSubSErvice/'.$id) }}" method="POST" id="main" novalidate>
                    {{ csrf_field() }}
                                ...
                                <div class="row">
                                                ...
                                                <select class="form-control" disabled>
                                                    @if(isset($services[0]) && !empty($services[0]))
                                                        @foreach($services as $ser)
                                                            <option value="{{ $ser->id }}" <?php if(isset($service_id) && !empty($service_id) && $service_id == $ser->id){echo "selected";}else{ echo "";}?> >{{ $ser->service_name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form_control_new">  
                                            ...
                                            <div class="form-group"> 
                                                <input class="form-control" name="sub_service_name" id="sub_service_name" value="{{ $subservices->sub_service_name }}" placeholder="Enter Sub Service Name" required> 
                                    ...
                                    <div class="col-md-12">
                                        <div class="form_control_new">  
                                            ...
                                            <div class="txtH"> Par / </div> <input class="form-control" name="unit_variable" value="{{ $subservices->unit_variable }}" id="unit_variable" placeholder="Enter unit e.g. hour or square meter" required> 
                                    ...
                                    <div class="col-md-12">
                                        <div class="form_control_new">  
                                            ...
                                            <div class="form-group untPriceVar"> 
                                                <input class="form-control" name="unit_price" id="unit_price" value="{{ $subservices->unit_price }}" placeholder="Enter price per unit variable" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form_control_new">  
                                            ...
                                            <div class="form-group unitDuration"> 
                                                <input class="form-control" name="unit_duration" id="unit_duration" value="{{ $subservices->unit_duration }}" placeholder="Enter estimated time for one unit in minutes" required> 
