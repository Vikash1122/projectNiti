                                            ...
                                            @foreach($services as $ser)
                                                <div class="sub_ser_box_list">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 text-center">{{$ser->service_name}}</div>
                                                        <div class="col-md-2 text-center">{{$ser->instant_service_price}} AED</div>
                                                        <form method="post" action="{{ route('chargeupdate.post') }}">
                                                        {{ csrf_field() }}
                                                            <input type="hidden" name="service_id" value="{{$ser->id}}"/>
                                                            <div class="col-md-3 text-center">
                                                                <div class="hidden"> {{$ser->surveyer_price}} AED</div>
                                                                <div>
                                                                    <input type="text" class="text-center" name="surveyer_price" value="{{$ser->surveyer_price}}"> 
                                                                </div>
                                                            </div>
