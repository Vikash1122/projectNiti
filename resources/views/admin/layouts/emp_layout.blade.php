...
<link href="{{ asset('public/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css') }}" rel="stylesheet" type="text/css" />
...
<link href="{{ asset('public/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('public/plugins/ios-switch/ios7-switch.css') }}" rel="stylesheet" type="text/css" media="screen">
...
<script src="{{ asset('public/js/chat.js') }}" type="text/javascript"></script>
    ...
    <script src="{{ asset('public/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/jquery-inputmask/jquery.inputmask.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/jquery-autonumeric/autoNumeric.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/ios-switch/ios7-switch.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/bootstrap-select2/select2.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/bootstrap-wysihtml5/wysihtml5-0.3.0.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.js') }}" type="text/javascript"></script>
                ...
                <div class="col-md-5">
                    ...
                    <div class="col-md-2">
                        <div class="dlt_emp_btn relativePosition">  
                            <h5>
                                <span class="cancle_sur_btn removeButton" onclick="removediv(${id});"><img src="{{ asset('public/img/error.png') }}" class="img-responsive"></span>
                            </h5> 
                        </div>
            </div>
            </div>`);
