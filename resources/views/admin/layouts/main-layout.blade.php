...
<script src="{{ asset('public/js/form_elements.js') }}" type="text/javascript"></script>
...
$('#rOleId').on('change',function(){
    ...
    <script>
            $(document).ready(function(){
                $('#main-menu-wrapper ul li').find('a').each(function(){
