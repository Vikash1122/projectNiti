...
<script src="{{ asset('public/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js') }}" type="text/javascript"></script>
    ...
    <script>
        $(document).ready(function(){
           // randomColor();
            ...
            //*amc Type select*//
            $("#amcName").change(function(){
                var amcName = document.getElementById("amcName").value;
            });
   ...
   <script src="{{ asset('public/developer/js/surveyer.js') }}" type="text/javascript"></script>
   ...
   <script>
        ...
        // var jobDate = $('#add_job_date').datepicker({
        //     autoclose: true
        // });

        var date = $("#add_job_date").datepicker({ dateFormat: 'dd,MM,yyyy' }).val();
