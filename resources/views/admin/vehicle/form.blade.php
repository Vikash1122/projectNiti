...
@section('content')
    <div class="content">
        ...
        <div class="content-box-main-ng ">
            ...
            <form method="POST" action="{{ route('vehicle.post') }}" enctype="multipart/form-data" id="main" novalidate>   
            {{ csrf_field() }} 
                                    ...
                                    <div class="upProfile_sec bgNone">
                                        <div class="form-group form-md-line-input">
                                            <div class="docMainBox profileImgBox">
                                                <img alt="" id="reg_card_copy" src="{{ asset('public/img/docVehicle.png') }}" class="center-block userImg img-responsive">
                                            </div>
                                        </div> 
                                    </div>
