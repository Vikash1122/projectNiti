                    ...
                    <div class="content-box-main">
                        <div class="box">
                            <div class="row">
                                ...
                                @if(isset($employee->alljobs) && !empty($employee->alljobs))
                                <div class="col-xl-9 col-md-9 order_history_box_main">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="headSec ">
                                                    ...
                                                    @if($employee->alljobs->status == 0)
                                                    <span class="complete">Requested</span>
                                                    @elseif($employee->alljobs->status == 1)
                                                    <span class="complete">Scheduled</span>
                                                    @elseif($employee->alljobs->status == 2)
                                                    <span class="complete">Proposed</span>
                                                    @elseif($employee->alljobs->status == 3)
                                                    <span class="complete">Accepted</span>
                                                    @elseif($employee->alljobs->status == 4)
                                                    <span class="complete">In Process</span>
                                                    @elseif($employee->alljobs->status == 5)
                                                    <span class="complete">Completed</span>
                                                    @elseif($employee->alljobs->status == 6)
                                                                ...
                                                                <div class="dtl_order_box_n">
                                                                    <div class="widget_user_list">
                                                                        <div class="jd_emp_name">
                                                                            <h4>{{ $employee->alljobs->firstname }} <span>{{ $employee->alljobs->lastname }}</span></h4>
                                                                        </div>      
                                                                        <div class="widget_img_box">
                                                                            @if(isset($employee->alljobs->profile_pic) && !empty($employee->alljobs->profile_pic))
                                                                                <img src="{{ fileurlUser().$employee->alljobs->profile_pic }}" class="">
                                                                            @else
                                                                                <img src="{{ asset('public/img/defaultIcon.png') }}" class="">
                                                                            @endif
                                                                        </div>
                                                                        <div class="widget-title">
                                                                            ...
                                                                            <div class="bs_inf_jd">
                                                                                <h5>Mobile : {{ $employee->alljobs->mobile }}</h5>
                                                                                <p>Email-id : {{ $employee->alljobs->email }}</p>
                                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12"> 
                                                                <div class="queries_cst" id="style-1">
                                                                    ...
                                                                    @if(isset($employee->alljobs->jobServices[0]) && !empty($employee->alljobs->jobServices[0]))
                                                                    @foreach($employee->alljobs->jobServices as $services)
                                                                        <li>
                                                                            <div class="row">
                                                                                <div class="col-sm-4">
                                                                                    <div class="dtl_cst">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <div class="dtl_cst">
                                                                                        <h5>Query Date</h5>
                                                                                        <p>{{ date("d/m/Y", strtotime($services->created_at)) }}</p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>    
                                                                            <div class="row">
                                                                                <div class="col-sm-8">
                                                                                    <div class="dtl_cst">
                                                                                        <h5>Description</h5>
                                                                                        <p>{{ $services->specify_problem }}</p>
                                                                                        <p>{{ $services->additional_notes }}</p>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                    <div class="dtl_cst">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="serveor_dt" id="style-1" >
                                                        ...
                                                        @if(isset($employee->alljobs->surveyerdetail) && !empty($employee->alljobs->surveyerdetail))
                                                            <div class="order_history_box">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="dtl_order-hd">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="widget_img_box">
                                                                            @if(isset($employee->alljobs->emp_profile) && !empty($employee->alljobs->emp_profile))
                                                                                <img src="{{ fileurlemp().$employee->alljobs->emp_profile }}" class="">
                                                                            @else
                                                                                <img src="{{ asset('public/img/defaultIcon.png') }}" class="">
                                                                            @endif
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <h5>Name</h5>
                                                                        <p>{{ $employee->alljobs->surveyerdetail->employee_name }}</p>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <h5>Survey Date</h5>
                                                                        <p>{{ $employee->alljobs->surveyerdetail->servey_date }}</p>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <h5>Status</h5>
                                                                        @if(isset($employee->alljobs->reportservice[0]) && !empty($employee->alljobs->reportservice[0]))
                                                                        <p>Complete</p>
                                                                        @else
                                                                        <p>Pending</p>
                                                                        @endif
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    @foreach($employee->alljobs->reportservice as $report)
                                                                        <div class="col-md-4">
                                                                            <div class="ser_footage">
                                                                            @if(isset($report->service_img) && !empty($report->service_img))
                                                                                <img src="{{ fileurlReport().$report->service_img }}" class="img-responsive" />
                                    ...
                                    @if(isset($employee->vehicle_detail) && !empty($employee->vehicle_detail))
                                        <div class="order_history_box">
                                            <div class="row">   
                                                <div class="col-md-12">
                                                    <div class="dtl_order-hd">
                                                    ...
                                                    <div class="row dtl_order_box_n">
                                                        <div class="col-xl-3 col-md-3">
                                                            <div class="widget_user_list">
                                                                ...
                                                                <div class="widget-title">
                                                                    <h4>{{ $employee->vehicle_detail->employee_name }} </h4>
                                                                    <h5>( Driver )</h5>
                                                                </div>
                                                            </div>        
                                                        </div>
                                                        ...
                                                        <div class="col-xl-9 col-md-9">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <h5>Vehicle Type</h5>
                                                                    <p>{{ $employee->vehicle_detail->vehicle_type }}</p>
                                                                </div>

                                                                <div class="col-md-4">
                                                                    <h5>Plate Number</h5>
                                                                    <p>{{ $employee->vehicle_detail->vehicle_no }}</p>
                                                                </div>

                                                                <div class="col-md-4">
                                                                    <h5>Vehicle Modal</h5>
                                                                    <p>{{ $employee->vehicle_detail->modal_no }}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    @endif
                                        <div class="clearfix"></div>
                                    @if((isset($employee->alljobs->surveyerdetail) && !empty($employee->alljobs->surveyerdetail)) || (isset($employee->vehicle_detail) && !empty($employee->vehicle_detail)) || (isset($employee->team_member) && !empty($employee->team_member)))
                                        <div class="order_history_box">
                                            <div class="row">   
                                                <div class="col-md-12">
                                                    <div class="dtl_order-hd">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="order_history_box">
                                                                <div class="team_members">
                                                                    <div class="widget_img_box">
                                                                    @if(isset($employee->alljobs->surveyerdetail->emp_profile) && !empty($employee->alljobs->surveyerdetail->emp_profile))
                                                                        <img src="{{ fileurlemp().$employee->alljobs->surveyerdetail->emp_profile }}" class="img-responsive">
                                                                    @else
                                                                        <img src="{{ asset('public/img/defaultIcon.png') }}" class="img-responsive">
                                                                    @endif
                                                                    </div>
                                                                    <div class="widget-title">
                                                                        <h4>{{ $employee->alljobs->surveyerdetail->employee_name }}</h4>
                                                                        <h5>( {{ $employee->alljobs->surveyerdetail->emp_mobile }} )</h5>
                                                                        <p>{{ $employee->alljobs->surveyerdetail->emp_role }}</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    @if(isset($employee->vehicle_detail) && !empty($employee->vehicle_detail))
                                                        <div class="col-md-3">
                                                            <div class="order_history_box">
                                                                <div class="team_members">
                                                                    <div class="widget_img_box">
                                                                    @if(isset($employee->vehicle_detail->emp_profile) && !empty($employee->vehicle_detail->emp_profile))
                                                                        <img src="{{ fileurlemp().$employee->vehicle_detail->emp_profile }}" class="img-responsive">
                                                                    @else
                                                                        <img src="{{ asset('public/img/defaultIcon.png') }}" class="img-responsive">
                                                                    @endif
                                                                    </div>
                                                                    <div class="widget-title">
                                                                        <h4>{{ $employee->vehicle_detail->employee_name }}</h4>
                                                                        <h5>( {{ $employee->vehicle_detail->emp_mobile }} )</h5>
                                                                        <p>{{ $employee->vehicle_detail->emp_role }}</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @if(isset($employee->team_member) && !empty($employee->team_member))
                                                    @foreach($employee->team_member as $team)
                                                        <div class="col-md-3">
                                                            <div class="order_history_box">
                                                                <div class="team_members">
                                                                    <div class="widget_img_box">
                                                                                ...
                                                                                <div class="order_history_box">
                                                                                    <div class="row">
                                                                                        <div class="col-md-12">
                                                                                            <div class="int_dt">
                                                                                                <div class="img_intv">
                                                                                                    <img  src="{{ asset('public/img/hamber.jpg') }}" class="img-responsive" />
                                                                                                </div> 
        ...
        <div class="modal fade videoModalMainDiv videoModal" id="videoModal1" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="closeBtnMain">
                <button type="button" class="close closeBtnN" data-dismiss="modal" onclick="closedestroy()" aria-label="Close">
                    <span aria-hidden="true"><img src="{{ asset('public/img/closebtn.png') }}"  /></span>
                </button>
            </div>
