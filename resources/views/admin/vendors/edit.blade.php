@extends('admin.layouts.vendor_layout')
...
<div class="content">
    ...
    <div class="content-box-main-ng marginBottom0">
        ...
        <form id="msform" method="post" action="{{ url('admin/vendors/edit/'.$id) }}" enctype=multipart/form-data novalidate>
            {{ csrf_field() }} 
            <div class="content-box-main-vdr">
                                ...
                                <div class="upProfile_sec">
                                    <div class="form-group form-md-line-input">
                                        <div class="docMainBox profileImgBox borderVdrProfile">
                                            @if(isset($vendor->profile_img) && !empty($vendor->profile_img))
                                                <img alt="" id="profile_copy" src="{{ fileurlVendor().$vendor->profile_img }}" class="center-block userImg img-responsive">
                                            @else
                                                <img alt="" id="profile_copy" src="{{ asset('public/img/defaultIcon.png') }}" class="center-block userImg img-responsive">
                                            @endif
                                            
                                            <div class="up_img_pro" style="width:60px;margin:10px auto;display:block;">
                                                <!-- <img alt="" id="profile_copy" src="{{ asset('public/img/upload-icon.png') }}" class="center-block userImg img-responsive"> -->
                                ...
                                <div class="upProfile_sec">
                                    <div class="form-group form-md-line-input">
                                        <div class="docMainBox profileImgBox greenBg borderVdrLogo">
                                            @if(isset($vendor->company_logo) && !empty($vendor->company_logo))
                                            <img alt="" id="company_logo" src="{{ fileurlVendor().'logo/'.$vendor->company_logo }}" class="center-block userImg img-responsive">
                                            @else
                                            <img alt="" id="company_logo" src="{{ asset('public/img/defaultIcon.png') }}" class="center-block userImg img-responsive">
                                            @endif
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control focus1" name="contact_person_name" value="{{ $vendor->contact_person_name }}" id="contact_person_name" placeholder="Enter Contact Person’s Name" required> 
                                    <div class="iconDiv">
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control focus1" name="designation" value="{{ $vendor->designation }}" id="designation" placeholder="Enter Designation"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>                                   
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control focus1" name="mobile" value="{{ $vendor->mobile }}" id="mobile" placeholder="Enter Mobile Number" required> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div> 
                                    <div class="messages"></div>
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control focus1" name="contact_person_email" value="{{ $vendor->contact_person_email }}" id="contact_person_email" placeholder="Enter Email Address" required> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">   
                            <div class="col-md-6">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="emirates_id" value="{{ $vendor->emirates_id }}" id="emirates_id" placeholder="Enter Emirates ID Number" required>
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <!-- <div class="messages"></div> -->
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control focus1" name="company_name" value="{{ $vendor->company_name }}" id="company_name" placeholder="Enter Company Name" required>
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control focus1" name="registration_no" value="{{ $vendor->registration_no }}" id="registration_no" placeholder="Enter Number" required>
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control focus1" name="owner_name" value="{{ $vendor->owner_name }}" id="owner_name" placeholder="Enter Owner Name" required> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    <div class="label_head">Email</div>
                                    <input type="email" class="form-control focus1" name="email" value="{{ $vendor->email }}" id="email" placeholder="Enter Email Address" required>
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="fax_no" value="{{ $vendor->fax_no }}" id="fax_no" placeholder="Enter Fax Number"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                   <!--  <div class="messages"></div> -->
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control focus1" name="company_mobile" value="{{ $vendor->company_mobile }}" id="company_mobile" placeholder="Enter Number" required> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">  
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <textarea name="address" rows="4" class="form-control focus1" placeholder="Enter Company Address" style="height:auto !important;" required>{{ $vendor->address }}</textarea>
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                            ...
                            <div class="col-md-6">
                                <div class="form_control_new">  
                                    ...
                                    <textarea rows="4" name="warehouse_addr" class="form-control" placeholder="Enter Warehouse Address" style="height:auto !important;">{{ $vendor->warehouse_addr }}</textarea>
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                  <!--   <div class="messages"></div> -->
                ...
                <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        ...
                        <div id="appendDtata">
                            @if(isset($vendor->selected_services[0]) && !empty($vendor->selected_services[0]))
                                            ...
                                            <div class="label_head">Select Service</div>
                                                <select name="service_id[]" id="sService_type"  class="form-control" required>
                                                    ...
                                                    @foreach($services as $ser)
                                                        <option value="{{ $ser->id }}" <?php if($serv->service_id == $ser->id){ echo "selected";}else{ echo "";}?>>{{ $ser->service_name }}</option>
                                                    @endforeach
                                                    @endif
                                                </select>
                                            ...
                                            <div class="form_control_new">  
                                                ...
                                                <select name="sub_service_id[]" id="subService_type"  class="form-control" required>
                                                    ...
                                                    @foreach($subservices as $sub)
                                                        <option value="{{ $sub->id }}" <?php if($serv->sub_service_id == $sub->id){ echo "selected";}else{ echo "";}?>>{{ $sub->sub_service_name }}</option>
                                                    @endforeach
                                                    @endif
                                                </select>
                                                <div class="iconDiv">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input name="tax_reg_number" id="tax_reg_number" value="{{ $vendor->tax_reg_number }}" class="form-control focus1" placeholder="Enter Tax Number">
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control focus1" name="bank_name" value="{{ $vendor->bank_name }}" id="bank_name" placeholder="Bank Name"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control focus1" name="ifsc_code" value="{{ $vendor->ifsc_code }}" id="ifsc_code" placeholder="IFSC Code"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control focus1" name="branch_code" value="{{ $vendor->branch_code }}" id="branch_code" placeholder="Branch Code">
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control focus1" name="account_no" value="{{ $vendor->account_no }}" id="account_no" placeholder="Account Number"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control focus1" name="account_holder_name" value="{{ $vendor->account_holder_name }}" id="account_holder_name" placeholder="Account Holder Name" required>
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                            ...
                            <div class="col-md-6">
                                <div class="form_control_new"> 
                                    ...
                                    <textarea rows="4" class="form-control" name="biling_address" style="height:auto !important;" placeholder="Billing Address" required>{{ $vendor->account_holder_name }}</textarea>
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <!-- <div class="messages"></div> -->
