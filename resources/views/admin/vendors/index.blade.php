...
@section('content')
    <div class="content">
        <div class="page-title"> 
            ...
            <a href="{{ route('vendors.form') }}" class="new_btn_add_service"><i class="fa fa-plus"></i> Add New Vendor </a>
            @endif
                                ...
                                <div class="mainWidget_ng">
                                    <div class="head_ng borderBottomNone">
                                        <div class="grid_box new_srv_box">
                                            ...
                                            @if(hasPermissionThroughRole('delete_vendor'))
                                                <a href="{{ url('admin/vendors/'.$vd->id.'/destroy') }}" onclick="return confirmation();" class="EditService editSub_btn pull-left dlt_btn" title="Delete Vendor">
                                                    <i class="fa fa-times"></i>
                                                </a>
                                            @endif

                                            @if(hasPermissionThroughRole('edit_vendor'))
                                                <a href="{{ url('admin/vendors/'.$vd->id.'/edit') }}" class=" pull-right edt_btn " title="Edit Vendor">
                                        ...
                                        <div class="icon_div">
                                            @if(isset($vd->company_logo) && !empty($vd->company_logo) )
                                                <img src="{{ fileurlVendor().'logo/'.$vd->company_logo }}" class="img-responsive" />
                                            @else
                                                <img src="{{ asset('public/img/vendorLogo.png') }}" class="img-responsive" />
                                            @endif
                                        </div>
                                    </div>

                                    <div class="title">
                                        <h4>{{ substr( $vd->company_name, 0, 15) . '...' }}</h4>
                                    </div>
                                    ...
                                    <div class="content_opt borderTop_none"> 
                                        <div class="service_title">
                                            <h5>Services</h5>
                                            <p>
                                            @if(isset($vd->services[0]) && !empty($vd->services[0]))
                                            <span> {{ $vd->services[0] }}</span>
                                            @endif
                                            @if(isset($vd->services[1]) && !empty($vd->services[1]))
                                            , <span>{{ $vd->services[1] }}</span>
                                            @endif
                                            </p>
                                        </div>
                                        ...
                                        <div class="card_loc">
                                            <div class="row">
                                                <div class="col-md-6 ">
                                                    ...
                                                    <div class="job_st_details">{{ $vd->contact_person_name }}</div>
                                                </div>

                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                    <div class="tiles-title card-text-heading">Mobile Number</div>
                                                    <div class="job_st_details">+971-{{ $vd->mobile }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card_loc">
                                            <div class="row">
                                                <div class="col-md-6 ">
                                                    ...
                                                    <div class="job_st_details">{{ $vd->payment_method }}</div>
                                                </div>

                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                    <div class="tiles-title card-text-heading">Payment Terms</div>
                                                    <div class="job_st_details">{{ $vd->payment_term }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="newActBtn_ng">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 text-center">
                                                    <a href="{{ url('admin/vendors/'.$vd->id.'/view') }}" class="btn">More Details</a>
                                                </div>
                                            </div>
                                        </div>
                ...
                if(json.length > 0){
                    $.each(json,function(index, value){
                        ...
                        if(value.company_logo == null || value.company_logo == ''){
                            var vendor_image = '<img src="{{ asset("public/img/vendorLogo.png") }}" class="img-responsive" />';
                        ...
                        if("<?php echo hasPermissionThroughRole('edit_vendor'); ?>"){
                            var edit_permission = '<a href="http://3.16.87.53/admin/vendors/'+value.id+'/edit" class=" pull-right edt_btn " title="Edit Vendor"><img src="{{ asset("public/img/edit_icons.png") }}" class="img-responsive" /></a>';
                        }
