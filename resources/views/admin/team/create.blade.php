            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="sub_service_form">
                         ...
                         <form action="{{ route('teams.post') }}" enctype="multipart/form-data" method="POST" id="main">
                            {{ csrf_field() }}
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form_control_new">  
                                                        ...
                                                        <div class="formGroup_ng">
                                                            <div class="form-group">
                                                            {!! Form::password('password',array('class' => 'form-control focus1','placeholder'=>'Password')) !!}
                                            ...
                                            <div class="row">    
                                                <div class="col-md-6">
                                                    <div class="form_control_new">  
                                                        ...
                                                        <div class="formGroup_ng">
                                                            <div class="form-group">
                                                            {!! Form::select('roles', $roles, isset($user_roles) ? $user_roles : [], ['placeholder' => 'Select Role','id'=>'rOleId','class' => 'form-control focus1']) !!}
                                                            <div class="messages"></div>
                                                            </div>
                                                            <div class="iconDiv">
                                                                <i class="fa fa-check" aria-hidden="true"></i>
