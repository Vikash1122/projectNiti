                                                    ...
                                                    <div class="form_control_new">  
                                                        ...
                                                        <div class="formGroup_ng">
                                                            <div class="form-group">
                                                                <input class="form-control focus1" name="firstname" id="firstname" value="{{ $user->firstname }}" placeholder="First Name" required> 
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form_control_new">  
                                                        ...
                                                        <div class="formGroup_ng">
                                                            <div class="form-group">
                                                                <input type="email" class="form-control focus1" name="email" value="{{ $user->email }}" id="email" placeholder="Email/Username" required> 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form_control_new">  
                                                        ...
                                                        <div class="formGroup_ng">
                                                            <div class="form-group">
                                                                <input type="tel" class="form-control focus1" maxlength="10" name="mobile" value="{{ $user->mobile }}" id="mobile" placeholder="Mobile" required> 
