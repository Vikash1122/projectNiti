                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="contact_person_name" id="contact_person_name" placeholder="Enter Contact Person’s Name" > 
                                    <div class="iconDiv">
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="designation" id="designation" placeholder="Enter Designation"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div> 
                                    <div class="messages"></div>                                  
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="mobile" id="mobile" placeholder="Enter Mobile Number"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div> 
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="contact_person_email" id="contact_person_email" placeholder="Enter Email Address"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="company_name" id="company_name" placeholder="Enter Company Name">
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="registration_no" id="registration_no" placeholder="Enter Number">
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="owner_name" id="owner_name" placeholder="Enter Owner Name"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="company_mobile" id="company_mobile" placeholder="Enter Number"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">  
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <textarea name="address" rows="4" class="form-control" placeholder="Enter Company Address" style="height:auto !important;"></textarea>
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input name="tax_reg_number" id="tax_reg_number"  class="form-control" placeholder="Enter Tax Number">
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="ifsc_code" id="ifsc_code" placeholder="IFSC Code"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="branch_code" id="branch_code" placeholder="Branch Code">
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="account_no" id="account_no" placeholder="Account Number"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="account_holder_name" id="account_holder_name" placeholder="Account Holder Name">
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
