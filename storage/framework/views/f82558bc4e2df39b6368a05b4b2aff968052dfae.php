...
<link href="<?php echo e(asset('public/lugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css')); ?>" rel="stylesheet" type="text/css" />
...
<script src="<?php echo e(asset('public/js/chat.js')); ?>" type="text/javascript"></script>
    ...
    $("#group_emp").on("change", function() {
        var emp_name = $('#group_emp').val();
        alert(emp_name);
        //$("#emp_group_add").html('');
                $("#emp_group_add").append(`<div class="form_control_new" >
                <div class="col-md-5">
                    <div class="form_control_new">  
                            <div class="label_head">Employee Name</div>
                            <div class="input-group"> 
                                <span class="input-group-addon" id="employee_name"><i class="fa fa-user"></i></span> 
                                <input class="form-control" disabled="true" name="employee_id[]" id="employee_name" value="Prem Maurya"> 
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="dlt_emp_btn relativePosition">  
                            <h5>
                                <span class="cancle_sur_btn removeButton"><img src="<?php echo e(asset('public/img/error.png')); ?>" class="img-responsive"></span>
                            </h5> 
                        </div>
            </div>
            </div>`);
       ...
       // $("#group_service").append($("<select><option>test</option><select/>"));
    });
   
    $('#removeButton').on('click', function(){
        alert("jhagsdjhsd");
        $(this).closest("#emp_group_add").remove();
    });
