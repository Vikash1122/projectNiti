            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="sub_service_form">
                         ...
                         <form action="<?php echo e(url('admin/teams/'.$id.'/edit')); ?>" enctype="multipart/form-data" method="POST" id="main" novalidate>
                                                        ...
                                                        <div class="upProfile_sec">
                                                            <div class="form-md-line-input">
                                                                <div class="docMainBox bannerImgBox">
                                                                    <div class="boxCircle">
                                                                        <?php if(isset($user->admin_profile) && !empty($user->admin_profile)): ?>
                                                                            <img alt="" id="service_icon" src="<?php echo e(fileurlAdmin().$user->admin_profile); ?>" class="center-block userImg img-responsive">
                                                                        <?php else: ?>
                                    ...
                                    <div class="col-md-offset-2 col-md-8 createProfile">
                                        <div class="content-box-main">
                                            <div class="row">
                                                    ...
                                                    <div class="form_control_new">  
                                                        ...
                                                        <div class="formGroup_ng">
                                                            <div class="form-group">
                                                                <input class="form-control focus1" name="firstname" id="firstname" value="<?php echo e($user->firstname); ?>" placeholder="First Name" required> 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form_control_new  rsuccess">  
                                                        ...
                                                        <div class="formGroup_ng">
                                                            <div class="form-group">
                                                                <input class="form-control" name="lastname" value="<?php echo e($user->lastname); ?>" id="lastname" placeholder="Last Name" > 
                                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form_control_new">  
                                                        ...
                                                        <div class="formGroup_ng">
                                                            <div class="form-group">
                                                                <input type="email" class="form-control focus1" name="email" value="<?php echo e($user->email); ?>" id="email" placeholder="Email/Username" required> 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form_control_new">  
                                                        ...
                                                        <div class="formGroup_ng">
                                                            <div class="form-group">
                                                                <input type="tel" class="form-control focus1" maxlength="10" name="mobile" value="<?php echo e($user->mobile); ?>" id="mobile" placeholder="Mobile" required> 
                                            ...
                                            <div class="row">    
                                                ...
                                                <div id="groupDIv">
                                                    <?php if(isset($user->group_id) && !empty($user->group_id)): ?>
                                                    <div class="col-md-6">
                                                        <div class="form_control_new fff1">
                                                            <div class="label_head">Group</div>
                                                            <div class="formGroup_ng">
                                                                <div class="form-group">
                                                                    <select name="group_id" class="form-control focus1" id="group_id" onchange="getVal(this.value)">
                                                                    ...
                                                                    <?php if(isset($groups) && !empty($groups)): ?>
                                                                        <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option <?php if(isset($user->group_id) && !empty($user->group_id) && $user->group_id == $grp->id){echo "selected";}else{ echo "";}?> value="<?php echo e($grp->id); ?>"><?php echo e($grp->group_name); ?></option>
