                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="content-box-main-ng marginBottom0">
                            ...
                            <form method="post" action="<?php echo e(route('contracts.post')); ?>" id="main" novalidate>
                                            ...
                                            <div class="row" >
                                                <div class="col-md-5">
                                                    <div class="form_control_new fff1">  
                                                        ...
                                                        <div class="form-group"> 
                                                            <input class="form-control focus12" name="pkg_service_name[]" id="pkg_service_name" placeholder="Enter Service Name" /> 
                                                        </div>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form_control_new fff2">  
                                                        ...
                                                        <div class="form-group"> 
                                                            <textarea class="form-control focus12" id="pkg_service_desc" name="pkg_service_desc[]" placeholder="Enter Service Description"></textarea>
...
<script type="text/javascript">
  ...
  function handleFormSubmit(form) {
    ...
    if(abc1==null || abc1=="" || abc2==null || abc2==""){ 
        ...
        var emptyAreas = $('.focus12').filter(function(index, element) {
