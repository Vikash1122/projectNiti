...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        <ul class="breadcrumb">
            ...
            <li><a href="#" class="active">Job Card Details</a> </li>
        </ul>
        ...
        <div class="content-box-main">
                            ...
                            <table class="table">
                                <thead>
                                    <tr style="background: #1b1e24;">
                                        <th>#</th>
                                        <th>Service Name</th>
                                        <?php if(isset($proposal[0]->text_content) && !empty($proposal[0]->text_content)): ?>
                                            <th>Description</th>
                                        <?php endif; ?>
                                ...
                                <tbody>
                                <?php $i = 1;?>
                                <?php $__currentLoopData = $proposal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jb_c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i); ?></td>
                                        <td>
            ...
            <?php if($proposal[0]->text_content == '' || $proposal[0]->text_content == NULL): ?>
            <div class="row">
                <div class="col-md-12">
                    <div class="content-box-main">
                            ...
                            <div class="row ">
                                <div class="col-md-8">
                                    <div class="content">
                                        ...
                                        <?php if(isset($proposal[0]) && !empty($proposal[0])): ?>
                                        <?php $__currentLoopData = $proposal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="order_history_box">
                                                        ...
                                                        <table class="table table-hover">
                                                            ...
                                                            <?php if(isset($card->serviceData[0]) && !empty($card->serviceData[0])): ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo e($sub->product_name); ?></td>
                                                                    <td><?php echo e($sub->qty); ?></td>
                                                                    <td><?php echo e($sub->unit_variable); ?></td>
                                                                    <td class="text-center"><?php echo e($sub->sub_service_price); ?></td>
                                                                </tr>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            <?php endif; ?>
                                                            </tbody>
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    ...
                                                                    <th>&nbsp;</th>
                                                                    <th>Total</th>
                                                                    <th class="text-center"><?php echo e($card->service_price); ?></th>
                                                                </tr>
                                                            </tfoot>
                                                        </table>
                                                    </div>
                                        ...
                                        <div class="contentBox">
                                            <div class="order_history_box">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                    <?php $__currentLoopData = $proposal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <p class="topPadding15"><?php echo e($card->service_name); ?> <span class="pull-right"><?php echo e($card->service_price); ?></span></p>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <p class="amtPay">Total Price <span class="pull-right" id="totalPrice"><?php echo e($proposal[0]->total_price); ?></span></p>
