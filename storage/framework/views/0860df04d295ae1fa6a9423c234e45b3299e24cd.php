        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="sub_service_form">
                    <form action="<?php echo e(route('categories.post')); ?>" method="POST" enctype="multipart/form-data" id="main" novalidate>
...
<script>
	...
	$('#serviceIid123').on('change',function(){
		...
		$.ajax({
			type : "get",
           	url:"<?php echo e(url('admin/categories/getajaxSubServicedata')); ?>?service_id="+serID,
