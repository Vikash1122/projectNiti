...
<div class="content">
                ...
                <div class="row">
                    <div class="col-md-12 sub_service_form">
                        <form action="<?php echo e(route('comment.post')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo e(csrf_field()); ?>

                        <input type="hidden" name="job_id" id="jobID" value="<?php echo e($id); ?>">
                            <div class="content-box-main">
                                ...
                                <?php if(isset($myarray[0]) && !empty($myarray[0])): ?>
                                <?php $__currentLoopData = $myarray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <input type="hidden" name="service_id[]" id="serviceID" value="<?php echo e($arr->id); ?>">
                                <div class="order_history_box " id="srvListBlock_<?php echo $arr->id;?>">
                                
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="ser_rpt_heading">
                                                <span class="pull-left"><?php echo e($arr->service_name); ?></span>
                                            </h4>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3 text-right">
                                            <div class="form_control_new">  
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <a type="button" class="btn btn-primary" data-serv_id="<?php echo e($arr->id); ?>" id="addReportData_<?php echo $arr->id;?>" onclick="addServ(this.getAttribute('data-serv_id'))">Add More</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="service_icon_box">
                                                <div class="icon_div service_bg">
                                                    <img id="service_icon_<?php echo $arr->id;?>" src="<?php echo e(asset('public/img/upload_icon22.png')); ?>" class="img-responsive">
                                                </div>
                                                <div class="row">
                                                        ...
                                                        <div class="srv_icon_upload">
                                                            ...
                                                            <div class="up_btn">
                                                                <div class="up_img_pro">
                                                                    <img alt="" id="service_icon_<?php echo $arr->id;?>" src="<?php echo e(asset('public/img/upload-icon.png')); ?>" class="center-block userImg img-responsive">
