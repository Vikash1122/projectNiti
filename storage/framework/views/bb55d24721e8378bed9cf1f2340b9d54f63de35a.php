...
<?php $__env->startSection('content'); ?>
    <div class="content">
        <div class="page-title"> 
            ...
            <a href="<?php echo e(route('vehicle.form')); ?>" class="new_btn_add_service"><i class="fa fa-plus"></i> Add New Vehicles </a>
            <!-- <?php endif; ?> -->
                                ...
                                <div class="head_ng borderBottomNone">
                                    <div class="grid_box new_srv_box">
                                        <div class="controller overlay">
                                            <?php if(hasPermissionThroughRole('delete_vehicle')): ?>
                                            <a href="<?php echo e(url('admin/vehicles/destroy/'.$veh->id)); ?>" onclick="return confirmation();" class="EditService editSub_btn pull-left dlt_btn" title="Delete Vendor">
                                                <i class="fa fa-times"></i>
                                            </a>
                                            <?php endif; ?> 

                                            <?php if(hasPermissionThroughRole('edit_vehicle')): ?>
                                            <a href="<?php echo e(url('admin/vehicles/editVehicle/'.$veh->id)); ?>" class=" pull-right edt_btn " title="Edit Vendor">
                                    ...
                                    <div class="icon_div">
                                    <?php if(isset($veh->vehicle_pic) && !empty($veh->vehicle_pic)): ?>
                                        <img src="<?php echo e(fileurlvehicle().$veh->vehicle_pic); ?>" class="img-responsive">
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('public/img/vehicleDefault.png')); ?>" class="img-responsive">
                                    <?php endif; ?>
                                    </div>
                                    <h4 class="text-center"><?php echo e($veh->manufacturer); ?></h4>
                                </div>

                                <div class="title">
                                    <h4>Vehicle No. <span><?php echo e($veh->vehicle_no); ?></span></h4>
                                </div>
                                    ...
                                    <div class="card_loc">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="job_st_details"><?php echo e($veh->registration_number); ?></div>
                                            </div>
                                        </div>
                                    </div>    
                                    ...
                                    <div class="card_loc">
                                        <div class="row">
                                            <div class="col-md-6 ">
                                                ...
                                                <div class="job_st_details"><?php echo e(date('d/m/y', strtotime($veh->registration_expiration))); ?></div>
                                            </div>
                                    ...
                                    <div class="card_loc">
                                        <div class="row">
                                            <div class="col-md-6 ">
                                                ...
                                                <div class="job_st_details"><?php echo e($veh->vehilce_color); ?></div>
                                            </div>

                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <div class="tiles-title card-text-heading">Vehicle Partner</div>
                                                <div class="job_st_details"><?php echo e($veh->vehicle_partner); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <?php if(hasPermissionThroughRole('view_vehicle_info')): ?>
                                                    <a href="<?php echo e(url('admin/vehicles/viewVehicle/'.$veh->id)); ?>" class="btn">Vehicle Info</a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
...
$('#searchVehicle').on('keyup',function(){ 
    //if($(this).val().length >= 2) {
        ...
        $.ajax({
            type : 'get',
            url : "<?php echo e(route('vehicles.search')); ?>",
            data:{
                'search':$value
                },
                ...
                if(json.length > 0){
                    $.each(json,function(index, value){
                        ...
                        if(value.vehicle_pic == null || value.vehicle_pic == ''){
                            var vehicle_image = '<img src="<?php echo e(asset("public/img/vehicleDefault.png")); ?>" class="img-responsive" />';
                        }else{
                            var vehicle_image = '<img src="'+ vehicle_image1 +'" class="img-responsive">';
                        }
                        var edit_permission='';
                        if("<?php echo hasPermissionThroughRole('edit_vehicle'); ?>"){
                            var edit_permission = '<a href="http://3.16.87.53/admin/admin/vehicles/editVehicle/'+value.id+'" class=" pull-right edt_btn " title="Edit Vehicle"><img src="<?php echo e(asset("public/img/edit_icons.png")); ?>" class="img-responsive"></a>';
                        }
