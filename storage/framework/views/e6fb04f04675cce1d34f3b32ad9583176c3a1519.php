                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" name="employee_name" value="<?php echo e($employee->employee_name); ?>" id="employee_name" placeholder="Employee Name" aria-describedby="employee_name"> 
                                        <div class="iconDiv">
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" type="tel" maxlength="10" minlength="10"  value="<?php echo e($employee->emp_mobile); ?>" name="emp_mobile" id="emp_mobile" placeholder="Enter Number"> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" name="age" value="<?php echo e($employee->age); ?>" id="age" placeholder="Employee Age"> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new date_picker">  
                                        ...
                                        <input class="form-control" name="date_of_birth" value="<?php echo e(date('d-m-Y', strtotime($employee->date_of_birth))); ?>" id="date_of_birth" placeholder="Date Of Birth">
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" name="email_id" value="<?php echo e($employee->email_id); ?>" id="email_id" placeholder="Email-Id"> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" name="city" value="<?php echo e($employee->city); ?>" id="city" placeholder="Enter City"> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <textarea rows="5" name="permanent_address" class="form-control heightAuto" placeholder="Enter Permanent Address"><?php echo e($employee->permanent_address); ?></textarea>
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
