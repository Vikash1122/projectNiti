...
<?php $__env->startSection('content'); ?>
    <div class="content">
        ...
        <div class="content-box-main-ng marginBottom0">
            ...
            <form action="<?php echo e(route('employee.post')); ?>" method="POST" enctype="multipart/form-data" id="main" novalidate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" type="tel" maxlength="10" minlength="10" name="emp_mobile" id="emp_mobile" placeholder="Enter Number"> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <textarea rows="5" name="permanent_address" class="form-control heightAuto" id="permanent_address" placeholder="Enter Permanent Address"></textarea>
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
