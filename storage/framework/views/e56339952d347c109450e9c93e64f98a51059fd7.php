<?php $__env->startSection('content'); ?>
    <div class="content">
        ...
        <div class="content-box-main-ng marginBottom0">
            ...
            <form action="<?php echo e(url('admin/employees/update/'.$id)); ?>" method="POST" enctype="multipart/form-data" id="main" novalidate>
                ...
                <div class="content-box-main-vdr">
                            ...
                            <div class="upProfile_sec bgNone">
                                <div class="form-group form-md-line-input">
                                    <div class="docMainBox profileImgBox">
                                        ...
                                        <?php else: ?>
                                        <img alt="" id="profile_copy" src="<?php echo e(asset('public/img/vendorDefault.png')); ?>" class="center-block userImg img-responsive">
                                        <?php endif; ?>
                            ...
                            <div class="uploaBtn_ng">
                                ...
                                <div class="img_ng">
                                    <div class="up_img_pro">
                                        <img alt="" id="profile_copy" src="<?php echo e(asset('public/img/Icons_upload_white.png')); ?>" class="center-block userImg img-responsive">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control focus1" name="employee_name" value="<?php echo e($employee->employee_name); ?>" id="employee_name" placeholder="Employee Name" aria-describedby="employee_name"> 
                                        <div class="iconDiv">
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control focus1" type="tel" maxlength="10" minlength="10"  value="<?php echo e($employee->emp_mobile); ?>" name="emp_mobile" id="emp_mobile" placeholder="Enter Number"> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control focus1" name="age" value="<?php echo e($employee->age); ?>" id="age" placeholder="Employee Age"> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new date_picker">  
                                        ...
                                        <input class="form-control focus1" name="date_of_birth" value="<?php echo e(date('d-m-Y', strtotime($employee->date_of_birth))); ?>" id="date_of_birth" placeholder="Date Of Birth">
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control focus1" name="email_id" value="<?php echo e($employee->email_id); ?>" id="email_id" placeholder="Email-Id"> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                            ...
                            <div class="row">
                                        ...
                                        <select class="form-control form-control1 focus1" name="country" onchange="getCountry()" id="country" name="country">
                                            ...
                                            <?php if(isset($country) && !empty($country)): ?>
                                                <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cntry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php if(isset($employee->country) && !empty($employee->country) && ($employee->country == $cntry->name )){echo 'selected="selected"'; }else{ echo 'selected=""';}?> value="<?php echo e($cntry->name); ?>"><?php echo e($cntry->name); ?></option>
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control focus1" name="city" value="<?php echo e($employee->city); ?>" id="city" placeholder="Enter City"> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <textarea rows="5" name="local_address" class="form-control heightAuto" placeholder="Enter Local Address"><?php echo e($employee->local_address); ?></textarea>
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <textarea rows="5" name="permanent_address" class="form-control heightAuto focus1" placeholder="Enter Permanent Address"><?php echo e($employee->permanent_address); ?></textarea>
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                    ...
                    <hr>
                    <?php if(isset($employee->country) && !empty($employee->country)): ?>
                                ...
                                <div class="row">    
                                    <div class="col-md-6">
                                        <div class="form_control_new">  
                                            ...
                                            <input class="form-control" name="passport_number" value="<?php echo e($employee->passport_number); ?>" id="passport_number" placeholder="Enter Passport Number"> 
                                            <div class="iconDiv">
                                                <i class="fa fa-check" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form_control_new">  
                                            ...
                                            <input class="form-control" name="passport_exp_date" value="<?php echo e(date('d-m-Y', strtotime($employee->passport_exp_date))); ?>" id="passport_exp_date" placeholder="Enter Passport expiration">
                                            <div class="iconDiv">
                                                <i class="fa fa-check" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form_control_new date_picker">  
                                            ...
                                            <input class="form-control" name="visa_expiration" value="<?php echo e(date('d-m-Y', strtotime($employee->visa_expiration))); ?>" id="visa_expiration" placeholder="Enter Visa expiry date">
                                            <div class="iconDiv">
                                                <i class="fa fa-check" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form_control_new">  
                                            ...
                                            <input class="form-control" name="emirates_id" value="<?php echo e($employee->emirates_id); ?>" id="emirates_id" placeholder="Enter Emirates Id"> 
                                            <div class="iconDiv">
                                                <i class="fa fa-check" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form_control_new date_picker">  
                                            ...
                                            <input class="form-control" name="emirates_exp_date" value="<?php echo e(date('d-m-Y', strtotime($employee->emirates_exp_date))); ?>" id="emirates_exp_date" placeholder="Enter Emirates expiration"> 
                                            <div class="iconDiv">
                                                <i class="fa fa-check" aria-hidden="true"></i>
                                            </div>
                                        </div>
                            ...
                            <div class="row">    
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" name="employee_code" value="<?php echo e($employee->employee_code); ?>" id="employee_code" placeholder="Employee Code" aria-describedby="employee_code"> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div> 
                                        <div class="messages"></div>
                            ...
                            <div class="row marginBtoom100">
                                <div class="col-md-3">
                                    <div class="form-group form-md-line-input docDiv-ng">
                                        ...
                                        <?php else: ?>
                                            <img alt="" id="passport" src="<?php echo e(asset('public/img/passportCopy.png')); ?>" class="center-block userImg img-responsive">
                                        <?php endif; ?>
                                            <div class="uploadProfile">
                                                <div class="btn default btn-file btn-uploadnew">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-md-line-input docDiv-ng">
                                        ...
                                        <?php else: ?>
                                        <img alt="" id="visa" src="<?php echo e(asset('public/img/visaCopy.png')); ?>" class="center-block userImg img-responsive">
                                        <?php endif; ?>
                                            <div class="uploadProfile">
                                                <div class="btn default btn-file btn-uploadnew">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-md-line-input docDiv-ng">
                                        ...
                                        <?php else: ?>
                                        <img alt="" id="emirates" src="<?php echo e(asset('public/img/emirateIdCopy.png')); ?>" class="center-block userImg img-responsive">
                                        <?php endif; ?>
                                            <div class="uploadProfile">
                                                <div class="btn default btn-file btn-uploadnew">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-md-line-input docDiv-ng">
                                        ...
                                        <?php else: ?>
                                            <img alt="" id="dl_copy" src="<?php echo e(asset('public/img/dlCopy.png')); ?>" class="center-block userImg img-responsive">
                                        <?php endif; ?>
                                            <div class="uploadProfile">
                                                <div class="btn default btn-file btn-uploadnew">
