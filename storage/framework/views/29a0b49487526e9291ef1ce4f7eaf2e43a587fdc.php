<?php $__env->startSection('content'); ?>
    <div class="content">
        ...
        <div class="content-box-main-ng ">
            ...
            <form method="POST" action="<?php echo e(url('admin/vehicles/update/'.$id)); ?>" enctype="multipart/form-data" id="main" novalidate>   
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group hasVal">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" name="manufacturer" value="<?php echo e($vehicle->manufacturer); ?>" id="manufacturer" placeholder="Enter Manufacturer" required> 
                                        <div class="iconDiv">
                                ...
                                <div class="col-md-6 form-group hasVal">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" name="vehicle_no" value="<?php echo e($vehicle->vehicle_no); ?>" id="vehicle_no" placeholder="Enter Number" required> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" name="modal_no" value="<?php echo e($vehicle->modal_no); ?>" id="modal_no" placeholder="Enter Modal Number" required> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new date_picker">  
                                        ...
                                        <input class="form-control" name="manufacturing_year" value="<?php echo e(date('d-m-Y', strtotime($vehicle->manufacturing_year))); ?>"id="manufacturing_year" placeholder="Enter Manufacturing Year" autocomplete="off" required>
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" name="vehicle_partner" value="<?php echo e($vehicle->vehicle_partner); ?>" id="vehicle_partner" placeholder="Enter Partner" required>
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" name="owner_name" value="<?php echo e($vehicle->owner_name); ?>" id="owner_name" placeholder="Enter Name" required> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" value="<?php echo e($vehicle->vehilce_color); ?>" name="vehilce_color" id="vehilce_color" placeholder="Enter Color" required> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" name="registration_number" value="<?php echo e($vehicle->registration_number); ?>" id="registration_number" placeholder="Enter Registration Number" required> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <div class="form_control_new date_picker ">  
                                        ...
                                        <input class="form-control" name="registration_expiration" id="registration_expiration" value="<?php echo e(date('d-m-Y', strtotime($vehicle->registration_expiration))); ?>" placeholder="Registration expiration" required> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                       <div class="messages"></div>
                                    ...
                                    <div class="upProfile_sec bgNone">
                                        <div class="form-group form-md-line-input">
                                            <div class="docMainBox profileImgBox">
                                                ...
                                                <img alt="" id="reg_card_copy" src="<?php echo e(fileurlvehicle().$vehicle->registration_card); ?>" class="center-block userImg img-responsive">
                                                <?php else: ?>
                                    ...
                                    <div class="upProfile_se bgNone">
                                        <div class="form-group form-md-line-input">
                                            <div class="docMainBox profileImgBox">
                                                ...
                                                <img alt="" id="reg_card_copy" src="<?php echo e(fileurlvehicle().$vehicle->vehicle_pic); ?>" class="center-block userImg img-responsive">
                                                <?php else: ?>
