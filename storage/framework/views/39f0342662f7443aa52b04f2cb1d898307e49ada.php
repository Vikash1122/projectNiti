<?php $__env->startSection('content'); ?>
    <div class="content">
        ...
        <div class="content-box-main-ng marginBottom0">
            ...
            <form action="<?php echo e(url('admin/inventry/products/'.$id)); ?>" method="POST" enctype="multipart/form-data" id="main" novalidate>
                                        ...
                                        <select name="sub_service_id[]" id="subService_type"  class="multiselect form-control form-control1" multiple>
                                            ...
                                            <?php $arr2 = array();
                                                ...
                                                foreach($subservices as $sub){
                                                    ...
                                                    ?> 
                                                    <option <?= $selected; ?> value="<?php echo e($sub->id); ?>" ><?php echo e($sub->sub_service_name); ?></option>
                                            <?php }} ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="label_head">Product Name</div>
                                        <input class="form-control focus1" name="product_name" value="<?php echo e($products->product_name); ?>" id="product_name" placeholder="Product Name" required>   
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form_control_new form-group">  
                                        ...
                                        <input class="form-control focus1" name="product_code" value="<?php echo e($products->product_code); ?>" id="product_code" placeholder="Product Code" required> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div> 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form_control_new  form-group">  
                                        ...
                                        <input class="form-control focus1" name="qty" value="<?php echo e($products->qty); ?>" id="qty" placeholder="Quantity" required> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>  
                                ...
                                <div class="col-md-6">
                                    <div class="form_control_new  form-group">  
                                        ...
                                        <input class="form-control focus1" name="price" value="<?php echo e($products->price); ?>" id="price" placeholder="Price" required> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div> 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form_control_new  form-group">  
                                        ...
                                        <input class="form-control focus1" name="selling_price" value="<?php echo e($products->selling_price); ?>" id="selling_price" placeholder="Selling Price" > 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div>
                                        <div class="messages"></div>  
                                ...
                                <div class="col-md-6">
                                    <div class="form_control_new">  
                                        ...
                                        <input class="form-control" name="custom_price" value="<?php echo e($products->custom_price); ?>" id="custom_price" placeholder="Custom Price" > 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div> 
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form_control_new form-group">  
                                        ...
                                        <input class="form-control focus1" name="availability_days" value="<?php echo e($products->availability_days); ?>" id="availability_days" placeholder="Availability Days" required> 
                                        <div class="iconDiv">
                                            <i class="fa fa-check" aria-hidden="true"></i>
                                        </div> 
                                        <div class="messages"></div> 
                                        ...
                                        <select class="multiselect1 form-control form-control1" name="vendor_id[]" id="vendor_id" multiple required>
                                            ...
                                            <?php $arr = array();
                                                ...
                                                foreach($vendors as $vendr){
                                                    ...
                                                    ?> 
                                                    <option <?= $selected; ?> value="<?php echo e($vendr->id); ?>" ><?php echo e($vendr->company_name); ?></option>
                                            <?php }} ?>
