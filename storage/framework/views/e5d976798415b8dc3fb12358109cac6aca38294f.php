...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        <div class="page-title"> 
            ...
            <h3> Services </h3><i class="fa fa-angle-right"></i> <h3>View Sub Services</h3>
            <div class="sub_pages"><i class="fa fa-angle-right"></i> <h3>Edit Sub Service</h3></div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                ...
                <form action="<?php echo e(url('admin/services/'.$service_id.'/editSubSErvice/'.$id)); ?>" method="POST" id="main" novalidate>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form_control_new">  
                                            <div class="label_head" required="" disabled>Select Service</div>
                                                ...
                                                <select class="form-control" disabled>
                                                    <?php if(isset($services[0]) && !empty($services[0])): ?>
                                                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($ser->id); ?>" <?php if(isset($service_id) && !empty($service_id) && $service_id == $ser->id){echo "selected";}else{ echo "";}?> ><?php echo e($ser->service_name); ?></option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form_control_new">  
                                            ...
                                            <div class="form-group"> 
                                                <input class="form-control" name="sub_service_name" id="sub_service_name" value="<?php echo e($subservices->sub_service_name); ?>" placeholder="Enter Sub Service Name" required> 
                                    ...
                                    <div class="col-md-12">
                                        <div class="form_control_new">  
                                            ...
                                            <div class="txtH"> Par / </div> <input class="form-control" name="unit_variable" value="<?php echo e($subservices->unit_variable); ?>" id="unit_variable" placeholder="Enter unit e.g. hour or square meter" required> 
                                    ...
                                    <div class="col-md-12">
                                        <div class="form_control_new">  
                                            ...
                                            <div class="form-group untPriceVar"> 
                                                <input class="form-control" name="unit_price" id="unit_price" value="<?php echo e($subservices->unit_price); ?>" placeholder="Enter price per unit variable" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form_control_new">  
                                            ...
                                            <div class="form-group unitDuration"> 
                                                <input class="form-control" name="unit_duration" id="unit_duration" value="<?php echo e($subservices->unit_duration); ?>" placeholder="Enter estimated time for one unit in minutes" required> 
