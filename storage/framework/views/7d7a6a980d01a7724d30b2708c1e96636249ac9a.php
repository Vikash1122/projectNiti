                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form_control_new">  
                                                                ...
                                                                <div class="input-group"> 
                                                                    ...
                                                                    <input class="form-control" name="slotstart_time" id="slotstart_time" placeholder="9:00 AM - 12:00 PM"> 
                                                                </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form_control_new">  
                                                                ...
                                                                <div class="input-group"> 
                                                                    ...
                                                                    <input class="form-control" name="slotend_time" id="slotend_time" placeholder="9:00 AM - 12:00 PM"> 
                                                                </div>
