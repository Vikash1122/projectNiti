    ...
    <?php $__env->startSection('content'); ?>
        <div class="content">
            ...
            <div class="row">
                <form method="post" action="<?php echo e(url('admin/inventry/products/requestInventory/'.$id)); ?>" >
                                                ...
                                                <div class="col-md-12">
                                                    <div class="job_desc_box_list">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-xs-6 text-right">
                                                                <h5 class="textHead">Team Size 
                                                                    <p class="inv_text"><?php echo e($jobs->total_emp); ?></p>
                                                                </h5>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">    
                                                            ...
                                                            <div class="col-sm-6 col-xs-6 text-right">
                                                                <h5 class="textHead">Day Slot</h5>
                                                                <p class="inv_text"><?php echo e($jobs->slot_name); ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="row">  
                                                            <div class="col-sm-6 col-xs-6">
                                                                <h5 class="textHead">Start Time</h5>
                                                                <p class="inv_text"><?php echo e($jobs->slotstart_time); ?></p>
                                                            </div>
                                                        </div>    
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form_control_new">  
                                                        ...
                                                        <div class="form-group"> 
                                                            <select name="product_id[]" id="product_Ids"  style="width:100%" required>
                                                                ...
                                                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($bd->id); ?>"><?php echo e($bd->product_name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                <?php endif; ?>
                                                            </select>
