                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="content-box-main" id="CurrentJobdate7">
                                <h4 style="font-weight: 500;" id="jobDate3">Date : <span style="color: #039347;" id="jobdt2"><?php echo e(date('d-m-Y')); ?></span></h4>
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="table-responsive">
                                                                            <table class="table">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td><?php echo e($jb->job_date); ?></td>
                                                                                        <td><?php echo e($jb->slot_name); ?></td>
                                                                                        <td><?php echo e($jb->slotstart_time); ?> - <?php echo e($jb->slotend_time); ?></td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="jd_desc_blk" id="style-1">
                                                                                ...
                                                                                <?php $__currentLoopData = $jb->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jbserv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <div class="card_main_srv_lst">
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <h5 class="textHead mar_bot nm_srv">Service Name : <span class="srv_name"><?php echo e($jbserv->service_name); ?></span></h5>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                ...
                                                                                                <?php if(isset($jbserv->jobServices) && !empty($jbserv->jobServices)): ?>
                                                                                                    <div class="problemText">
                                                                                                        <div class="pblIcon"><i class="fa fa-question-circle"></i></div>
                                                                                                        <div class="pblTxt"><?php echo e($jbserv->jobServices->specify_problem); ?></div>
                                                                                                    </div>

                                                                                                    <div class="additionalText">
                                                                                                        <div class="adtIcon"><i class="fa fa-info-circle"></i></div>
                                                                                                        <div class="adtTxt"><?php echo e($jbserv->jobServices->additional_notes); ?></div>
                                                                                                    </div>
                                                                                                <?php endif; ?>
                                                                                                </div>
                                                                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="modal_form_block">
                                            <form action="<?php echo e(route('surveyers.post')); ?>" method="post">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form_control_new">  
                                                            ...
                                                            <select name="surveyor_emp_id" id="surveyor_emp_id" style="width:100%" required>
                                                                ...
                                                                <?php if(isset($surver_emp) && !empty($surver_emp)): ?>
                                                                <?php $__currentLoopData = $surver_emp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $surv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($surv->id); ?>"><?php echo e($surv->employee_name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                <?php endif; ?>
                                                            </select>
                                                        </div>
