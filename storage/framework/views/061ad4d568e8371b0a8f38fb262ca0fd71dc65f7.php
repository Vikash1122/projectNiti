...
function alljobsinCal(b_nDate){
    $.ajax({
           type:"GET",
           url:"<?php echo e(route('ajaxDateJobs.dt')); ?>?date="+b_nDate,
...
/** For alloted jobs in calender end */
    ...
    <script src="<?php echo e(asset('public/developer/js/surveyer.js')); ?>"></script>
...
<script>
    ...
    function allotgroup(id){
        ...
        $('#group_idmy').on('change', function() {
           ...
           // alert( group_id );
            $.ajax({ 
                         url: "<?php echo e(route('orders.ajaxgroups')); ?>",
                                    ...
                                    // $.each(json, function(index, value) {
                                         ...
                                         if(json[0].teamleader_image != '' && json[0].teamleader_image != null){
                                            var emp_image = '<?php echo fileurlemp();?>'+ json[0].teamleader_image;
                                             ...
                                             var teamlead_img = '<img src="<?php echo e(asset("public/img/defaultIcon.png")); ?>" class="img-responsive">';
                                         }
                                         ...
                                         if(json[0].driver_image != '' && json[0].driver_image != null){
                                            var dr_image = '<?php echo fileurlemp();?>'+ json[0].driver_image;
                                             ...
                                             var driver_image = '<img src="<?php echo e(asset("public/img/defaultIcon.png")); ?>" class="img-responsive">';
                                         }
