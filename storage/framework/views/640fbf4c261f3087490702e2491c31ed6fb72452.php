<div class="page-sidebar " id="main-menu">
    <!-- <div class="scroll-wrapper page-sidebar-wrapper scrollbar-dynamic" style="position: relative;"> -->
        <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper" >
            ...
            <?php if(Auth::check() && Auth::user()->hasRole('surveyor') ): ?> 
                <li> 
            ...
            <?php elseif(Auth::check() && Auth::user()->hasRole('team') ): ?>
                <li>
            ...
            <?php elseif(Auth::check() && Auth::user()->hasRole('admin') ): ?> 
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li> <a href="<?php echo e(route('contracts.fp')); ?>" title="Contracts">Contracts</a> </li>
                        <li> <a href="<?php echo e(route('contracts.category')); ?>" title="Contract Categories">Contract Categories</a> </li>
                        <li> <a href="<?php echo e(route('admin.contracts')); ?>" title="All Contracts">All Contracts</a> </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li> <a href="<?php echo e(route('orders.approved')); ?>" title="Approved Orders">Approved Orders</a> </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li> <a href="<?php echo e(route('admin.users')); ?>" title="Users List"> Users List </a> </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li> <a href="<?php echo e(url('admin/teams')); ?>" title="Team List"> Team List </a> </li>
                        <!-- <li> <a href="<?php echo e(url('admin/roles')); ?>" title="Roles"> Roles</a> </li>
