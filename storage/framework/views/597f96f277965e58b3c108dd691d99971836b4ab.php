            ...
            <div class="row">
                <div class="col-md-4 ">
                    <div class="sub_service_form">
                        <form action="<?php echo e(route('services.post')); ?>" method="POST" enctype="multipart/form-data" id="main" novalidate>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="docMainBox">
                                                            <img alt="" id="service_icon" src="<?php echo e(asset('public/img/Icons_upload.png')); ?>" class="center-block userImg img-responsive">
