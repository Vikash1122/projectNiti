                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('mobile') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="tel" minlength="10" maxlength="10" class="form-control" name="mobile" value="<?php echo e(old('mobile')); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('contact_no') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="contact_no" type="tel" minlength="10" maxlength="10" class="form-control" name="contact_no" value="<?php echo e(old('contact_no')); ?>">
