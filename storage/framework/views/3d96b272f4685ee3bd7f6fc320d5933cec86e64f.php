            ...
            <div class="row">
                <div class="col-md-4 ">
                    <div class="sub_service_form">
                        <form method="post" action="<?php echo e(url('admin/contracts/editContract/'.$id)); ?>" >
                                            ...
                                            <div class="row srvLst">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form_control_new">  
                                                        ...
                                                        <div class="form-group"> 
                                                            <input class="form-control" name="package_type" value="<?php echo e($package->package_type); ?>" id="package_type" placeholder="Package Title" required> 
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12"> 
                                                    <div class="form_control_new">  
                                                        ...
                                                        <div class="form-group">  
                                                            <input class="form-control" name="package_price" value="<?php echo e($package->package_price); ?>" id="package_price" placeholder="Package Price" required> 
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12"> 
                                                    <div class="form_control_new">  
                                                        ...
                                                        <div class="form-group"> 
                                                            <input class="form-control" name="callouts" value="<?php echo e($package->callouts); ?>" id="callouts" placeholder="No of Callouts " required> 
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
