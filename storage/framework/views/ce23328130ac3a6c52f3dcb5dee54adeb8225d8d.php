                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="contact_person_name" value="<?php echo e($vendor->contact_person_name); ?>" id="contact_person_name" placeholder="Enter Contact Person’s Name" required> 
                                    <div class="iconDiv">
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="designation" value="<?php echo e($vendor->designation); ?>" id="designation" placeholder="Enter Designation"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>                                   
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="mobile" value="<?php echo e($vendor->mobile); ?>" id="mobile" placeholder="Enter Mobile Number" required> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div> 
                                    <div class="messages"></div>
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="contact_person_email" value="<?php echo e($vendor->contact_person_email); ?>" id="contact_person_email" placeholder="Enter Email Address" required> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="company_name" value="<?php echo e($vendor->company_name); ?>" id="company_name" placeholder="Enter Company Name" required>
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="registration_no" value="<?php echo e($vendor->registration_no); ?>" id="registration_no" placeholder="Enter Number" required>
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="owner_name" value="<?php echo e($vendor->owner_name); ?>" id="owner_name" placeholder="Enter Owner Name" required> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    <div class="label_head">Email</div>
                                    <input type="email" class="form-control" name="email" value="<?php echo e($vendor->email); ?>" id="email" placeholder="Enter Email Address" required>
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="company_mobile" value="<?php echo e($vendor->company_mobile); ?>" id="company_mobile" placeholder="Enter Number" required> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">  
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <textarea name="address" rows="4" class="form-control" placeholder="Enter Company Address" style="height:auto !important;" required><?php echo e($vendor->address); ?></textarea>
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input name="tax_reg_number" id="tax_reg_number" value="<?php echo e($vendor->tax_reg_number); ?>" class="form-control" placeholder="Enter Tax Number">
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="bank_name" value="<?php echo e($vendor->bank_name); ?>" id="bank_name" placeholder="Bank Name"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="ifsc_code" value="<?php echo e($vendor->ifsc_code); ?>" id="ifsc_code" placeholder="IFSC Code"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="branch_code" value="<?php echo e($vendor->branch_code); ?>" id="branch_code" placeholder="Branch Code">
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                            ...
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="account_no" value="<?php echo e($vendor->account_no); ?>" id="account_no" placeholder="Account Number"> 
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form_control_new">  
                                    ...
                                    <input class="form-control" name="account_holder_name" value="<?php echo e($vendor->account_holder_name); ?>" id="account_holder_name" placeholder="Account Holder Name" required>
                                    <div class="iconDiv">
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                    </div>
                                    <div class="messages"></div>
