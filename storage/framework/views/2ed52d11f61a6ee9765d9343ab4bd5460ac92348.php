...
<div class="content">
    ...
    <div class="row">
        <form method="post" action="<?php echo e(url('/admin/newjobs/'.$id.'/jobCard')); ?>" >
            ...
            <div class="col-md-12">
                <div class="content-box-main">
                    <div class="header_main_div_sec">
                        <div class="title">
                            <h5 class="pull-left" id="jobTitle_text">Job No :  <?php echo e($id); ?></h5>
                    ...
                    <div class="row">
                        <div class="col-md-12" id="job_card_service_list">
                            <input name="group_id" id="group_id" type="hidden" value="<?php echo e(Auth::user()->group_id); ?>"/>
                            <input name="job_id" id="job_id" type="hidden" value="<?php echo e($id); ?>"/>
                            ...
                            <?php if(isset($myarray[0]) && !empty($myarray[0])): ?>
                                                            ...
                                                            <div class="form_control_new">  
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($prd->id); ?>"><?php echo e($prd->product_name); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </select>
                                                            ...
                                                            <div class="form_control_new">  
                                                                ...
                                                                <div class="input-group">
                                                                    <select class="form-control" name="unit_variable_<?php echo $arr->id;?>[]" id="unit_variable" required>
                                                                        <option value="">Please Select</option>
                                                                    <?php $__currentLoopData = $subservices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($sub->unit_variable); ?>"><?php echo e($sub->unit_variable); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                ...
                                <script>
                                    ...
                                    function addnojobCard(job_id){
                                        $.ajax({
                                            type:"GET",
                                            url:"<?php echo e(route('ajaxjobCard.job')); ?>?job_id="+job_id,
