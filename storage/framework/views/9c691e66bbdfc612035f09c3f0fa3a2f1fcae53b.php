...
<div class="content">
    <div class="page-title"> 
        ...
        <?php if(hasPermissionThroughRole('add_products')): ?>
            <a href="<?php echo e(route('margin.form')); ?>" class="new_btn_add_service">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive tableDiv_ng">
                            <table class="table">
                                ...
                                <?php if(isset($margins[0]) && !empty($margins[0])): ?>
                                <?php $i = 1; ?>
                                <?php $__currentLoopData = $margins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $margin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-center"><?php echo e($i); ?></td>
                                        <td class="text-center"><?php echo e($margin->amount); ?></td>
                                        <td class="text-center"><?php echo e($margin->margin); ?></td>
                                        <td class="text-center"><div class="marginCircle"></div></td>
                                        <td class="text-center">
                                            
                                            <!-- <a href="#" title="Edit Margin"><i class="fa fa-pencil"></i></a> -->
                                           
                                            <a href="<?php echo e(url('admin/margins/destroy/'.$margin->id)); ?>" onclick="return confirm('Are you sure you want to delete this record?');" title="Delete Margin"><i class="fa fa-times"></i></a>
