        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="sub_service_form">
                    <form action="<?php echo e(url('admin/services/'.$id)); ?>" method="POST" enctype="multipart/form-data" id="main" novalidate>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form_control_new">  
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" value="<?php echo e($services->service_name); ?>" name="service_name" id="service_name" placeholder="Service Name" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form_control_new">  
                                            ...
                                            <div class="form-group"> 
                                                <input class="form-control" value="<?php echo e($services->service_code); ?>" name="service_code" id="service_code" placeholder="Service Code" required>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="docMainBox">
                                                        <?php if(isset($services->service_icon) && !empty($services->service_icon)): ?>
                                                            <img alt="" id="service_icon" src="<?php echo e(fileurlservice().$services->service_icon); ?>" class="center-block userImg img-responsive">
                                                        <?php else: ?>
