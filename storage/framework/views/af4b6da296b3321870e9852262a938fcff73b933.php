...
<div class="content">
    <div class="page-title"> 
        ...
        <a href="<?php echo e(route('orders.form')); ?>" class="new_btn_add_service"><i class="fa fa-plus"></i> Add New Order </a>
        ...
        <div class="col-md-12">
            <div class="categoriProJobs">
                <ul>
                    ...
                    <li onclick="location.href='<?php echo e(route('orders.jobs')); ?>'">Jobs</li>
                    <li>Projects</li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="orderBox_ng">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h4>PPMP No. <?php echo e($ordr['id']); ?></h4>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="odrInner">
...
$('#searchOrder').on('keyup',function(){ 
    ...
    $.ajax({
        type : 'get',
        url : "<?php echo e(route('orders.search')); ?>",
        data:{
            'search':$value
            },
...
function filter(){
    ...
    $.ajax({
        type : 'post',
        url : "<?php echo e(route('orders.filter')); ?>",
        data:{
...
function filterStatus(status){
    ...
    $.ajax({
        type : 'post',
        url : "<?php echo e(route('orders.statusFilter')); ?>",
        data:{
            'status':status
            },
        success:function(data){
