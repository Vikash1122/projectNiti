    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-4 ">
                ...
                <form action="<?php echo e(url('admin/services/'.$id.'/addSubService')); ?>" method="POST" id="main" novalidate>
                                                ...
                                                <select name="" id="" class="form-control" style="width:100%" required="" disabled>
                                                    ...
                                                    <?php if(isset($services[0]) && !empty($services[0])): ?>
                                                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($ser->id); ?>" <?php if(isset($id) && !empty($id) && $id == $ser->id){echo "selected";}else{ echo "";}?> ><?php echo e($ser->service_name); ?></option>
