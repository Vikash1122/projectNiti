    <?php $__env->startSection('content'); ?>
        <div class="content">
            ...
            <div class="content-box-main-ng marginBottom0">
                ...
                <form method="post" action="<?php echo e(url('admin/contracts/editContractCategory/'.$id)); ?>"  id="main" novalidate>
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <div class="form_control_new">  
                                            ...
                                            <select id="package_id" name="package_id" required>
                                                ...
                                                <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php if(isset($category->package_id) && !empty($category->package_id) && $category->package_id == $pack->id){echo "selected";}else{ echo "";}?> value="<?php echo e($pack->id); ?>"><?php echo e($pack->package_type); ?></option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form_control_new  fff1">  
                                                    ...
                                                    <div class="form-group"> 
                                                        <input class="form-control" name="title" value="<?php echo e($category->title); ?>" id="title" placeholder="Category Name" required> 
                                                    </div>
