                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 form-group">
                                                    <div class="form-group form-md-line-input ">
                                                        <div class="docMainBox servicePicMain_ng">
                                                            <img alt="" id="orderJobPic1_copy" src="<?php echo e(asset('public/img/upload_image.png')); ?>" class="center-block userImg img-responsive">
                                                ...
                                                <div class="col-md-3 form-group">
                                                    <div class="form-group form-md-line-input ">
                                                        <div class="docMainBox servicePicMain_ng">
                                                            <img alt="" id="orderJobPic11_copy" src="<?php echo e(asset('public/img/upload_image.png')); ?>" class="center-block userImg img-responsive">
                                                            <div class="uploadProfile">
                                                                <div class="btn default btn-file btn-uploadnew">
                                                ...
                                                <div class="col-md-3 form-group">
                                                    <div class="form-group form-md-line-input ">
                                                        <div class="docMainBox servicePicMain_ng">
                                                            <img alt="" id="orderJobPic12_copy" src="<?php echo e(asset('public/img/upload_image.png')); ?>" class="center-block userImg img-responsive">
                                                            <div class="uploadProfile">
                                                                <div class="btn default btn-file btn-uploadnew">
                                                ...
                                                <div class="col-md-3 form-group">
                                                    <div class="form-group form-md-line-input ">
                                                        <div class="docMainBox servicePicMain_ng">
                                                            <img alt="" id="orderJobPic13_copy" src="<?php echo e(asset('public/img/upload_image.png')); ?>" class="center-block userImg img-responsive">
                                                            <div class="uploadProfile">
                                                                <div class="btn default btn-file btn-uploadnew">
