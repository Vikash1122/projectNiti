        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="content-box-main-ng">
                    ...
                    <form action="<?php echo e(route('banners.post')); ?>" method="post" enctype="multipart/form-data" id="main" novalidate>
                                                            ...
                                                            <div class="upProfile_sec">
                                                                ...
                                                                <div class="form-md-line-input">
                                                                    <div class="docMainBox bannerImgBox">
                                                                        <img alt="" id="banner_img" src="<?php echo e(asset('public/img/no-banner.png')); ?>" class="center-block userImg img-responsive">
                                                                    </div>
                                                                </div>    
                                                            </div>
                                                        </div>
