                                    ...
                                    <div class="form_control_new">  
                                        ...
                                        <select class="multiselect" name="group_service[]" id="group_service" style="width:100%" multiple required>
                                            ...
                                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($ser->id); ?>" <?php //if(isset($groupData[0]->group_service) && !empty($groupData[0]->group_service)){ foreach($service as $serv){ if($ser->id == $service){echo "selected";}}}else{echo "";}?>><?php echo e($ser->service_name); ?></option>
                                                
                                               <!-- <option value="<?php echo e($ser->id); ?>" <?php// if(isset($ser->id) && !empty($ser->id))?>><?php echo e($ser->service_name); ?></option>-->
                                    ...
                                    <div class="form_control_new">  
                                        ...
                                        <select name="driver" id="driver" style="width:100%" required>
                                            ...
                                            <?php $__currentLoopData = $driver; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php if(isset($groupData[0]->driver) && !empty($groupData[0]->driver) && $groupData[0]->driver == $dr->id){echo "selected";}else{ echo "";}?> value="<?php echo e($dr->id); ?>"><?php echo e($dr->employee_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
