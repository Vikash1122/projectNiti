    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form_control_new">  
                ...
                <div class="">
                    <input class="form-control" name="name" id="name" placeholder="User Name" value="<?php echo e($role->name); ?>" required> 
                ...
                <div class="permissionListBox">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="checkbox check-primary text-left">
                                <input id="<?php echo e($pemsn->id); ?>" name="permissions[]" type="checkbox" value="<?php echo e($pemsn->id); ?>" <?php if(is_array($role->permissions->pluck('id')->toArray()) && in_array($pemsn->id, $role->permissions->pluck('id')->toArray())){ echo  "checked";} ?> >
                    ...
                    <div class="row">
                        ...
                        <?php $__currentLoopData = $pemsn->permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-3">  
                                <div class="checkbox check-primary text-left">
                                    <input id="<?php echo e($perm->id); ?>" name="permissions[]" type="checkbox" value="<?php echo e($perm->id); ?>" <?php if(is_array($role->permissions->pluck('id')->toArray()) && in_array($perm->id, $role->permissions->pluck('id')->toArray())){ echo  "checked";} ?> >
